...
class vehicleMakeComponent extends Component {
    ...
    handleCreatevehicleMake() {
        window.$('#vehicleMakeCreate').modal('show');
    }
    ...
    renderModel() {
        ...
        // xl / sm /  md /
        return (
            <div className="modal fade" id="vehicleMakeCreate" tabIndex="-1" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="createvehicleMake" aria-hidden="true">
                <div className="modal-dialog modal-md" role="document">
                    <div className="modal-content">
                        <div className="modal-header">
                            <h5 className="modal-title" id="exampleModalLabel">Create vehicleMake</h5>
            ...
            <div className="col-lg-12">
                <section className="box ">
                    <header className="panel_header">
                        <h2 className="title pull-left">vehicleMake</h2>
                        <div className="actions panel_actions pull-right">
                            <button type="submit" className="btn btn-success" onClick={() => { this.handleCreatevehicleMake(); }}>Add vehicleMake</button>
                        </div>
                    </header>
                </section>
                <section className="box ">
